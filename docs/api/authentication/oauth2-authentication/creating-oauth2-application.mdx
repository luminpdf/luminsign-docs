...
:::info
For the full list and descriptions, see: [OAuth 2.0 Scopes in Lumin](/docs/api/authentication/oauth2-authentication/scopes/)
:::
...
### Step 6: Configure App webhook (optional)

If you want to receive events from Lumin on behalf of users, you can configure an App webhook.

- **App webhook URL**: The URL where Lumin will send events to your app.

![App Webhook Configuration](../../webhooks/img/app-webhook.png)

:::info
For more details, see: [App webhooks](/docs/api/webhooks/app-callbacks/)
:::
...
- **[Private Authorization Code Grant](/docs/api/authentication/oauth2-authentication/private-authorization-code/)** — for confidential clients.
- **[Public Authorization Code Grant with PKCE](/docs/api/authentication/oauth2-authentication/public-authorization-code/)** — for public clients.