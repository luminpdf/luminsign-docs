...
| **Workspace** | `workspaces.read` | View the Workspace information that the user authenticated with. |
| **Templates** | `templates` | View and manage templates in a Lumin Workspace. |
| **Files (PDF documents)** | `pdf:files` | Create, edit, and delete PDF files stored in a Lumin Workspace. |
| **Files (PDF documents)** | `pdf:files.read` | Retrieve PDF documents stored in a Lumin Workspace. |
...
| **Agreements** | `agreements` | Create, update, or delete AgreementGen documents in a Lumin Workspace. |
