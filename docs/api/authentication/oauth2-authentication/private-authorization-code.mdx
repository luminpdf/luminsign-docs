...
- A Private (Confidential) OAuth 2.0 application has been created in Lumin. See: [Creating an OAuth 2.0 Application in Lumin](/docs/api/authentication/oauth2-authentication/creating-oauth2-application)
