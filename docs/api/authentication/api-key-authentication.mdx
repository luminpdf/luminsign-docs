...
- One key can be marked as the **Primary Key**. The Primary Key is used to generate **signatures** for [verifying Account webhook event payloads](/docs/api/webhooks/account-callbacks/#verify-the-webhook).
