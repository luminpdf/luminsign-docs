...
App webhooks receive events based on the **[OAuth scopes](/docs/api/authentication/oauth2-authentication/scopes/)** granted by users. For a complete list of available events, see [Supported event types](/docs/api/webhooks/webhook-overview#supported-event-types).
...
![image](../authentication/img/application-details.png)
