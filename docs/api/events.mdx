...
Replace `5090` with the port number your local server is using. Ngrok will start and display a UI in your terminal, including the public URL(s) that ngrok has generated for your local server (e.g., `https://<random>.ngrok.io`).
