...
## API Key
API key is the most common method for authenticating against Lumin Sign API. You can retrieve keys from the [Developer Settings page](https://sign-integration.luminpdf.com/developer/configuration) in the Lumin Sign Dashboard.
...
You can rotate API Key by generate a new key at [Developer Settings page](https://sign-integration.luminpdf.com/developer/configuration). The old keys will continue to work until you delete them.
