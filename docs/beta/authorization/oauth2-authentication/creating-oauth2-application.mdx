...
- **[Private Authorization Code Grant](/docs/beta/authorization/oauth2-authentication/private-authorization-code/)** — for confidential clients.
- **[Public Authorization Code Grant with PKCE](/docs/beta/authorization/oauth2-authentication/public-authorization-code/)** — for public clients.