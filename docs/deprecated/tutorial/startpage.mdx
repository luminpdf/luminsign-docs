...
Lumin Sign provides a [library](/docs/deprecated/client/sendAndSign) that can be used to collect this information. Of course, you can build any widget to collect this information, or skip this step altogether.
