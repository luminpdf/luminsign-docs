...
:::caution
Prerequisites: You need to obtain a bearer token from [Getting a Bearer Token](/docs/deprecated/category/getting-an-bearer-token)
:::

:::info
If you are using our [simple react widget](https://github.com/luminpdf/bananasign-integration), you can skip this step and [Launch Signing Flow](/docs/deprecated/tutorial/signing-flow/).
:::
## Creating a document
...
:::info
For more information, please visit: [Contract Temporary API](/docs/deprecated/api/contract-temporary)
:::
